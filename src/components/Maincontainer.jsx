          ...
          <main className=' p-8 space-y-6'>
            <section className='flex justify-between items-center'>
              ...
              <aside className='relative bg-white'>
                ...
                <svg className='absolute right-3.5 top-3 hover:cursor-pointer pointer-events-none' xmlns="http://www.w3.org/2000/svg" width="16" height="16" viewBox="0 0 16 16" fill="none">
